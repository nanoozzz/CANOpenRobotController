 ...
 *
 * The FLNLHelper/server is owned by M2FittsRobotHumanMachine as UIserver.
...
class M2FittsUILink {
   public:
     ...
     *
     * The FLNLHelper/server is owned by M2FittsRobotHumanMachine.
     */
   ...
   private:
    ...
    // It points to M2FittsRobotHumanMachine::UIserver.
